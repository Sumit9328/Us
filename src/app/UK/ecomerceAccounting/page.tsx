                            ...
                            <div className="col-md-6 py-16 border-[#fff] sm:flex  justify-end items-center">
                                <div className="col-md-10">
                                    ...
                                    <div className="col-md-10">
                                        ...
                                        <p className="text-[#fff] text-[48px] font-[600] leading-[53px]">Got questions? Chat with our local experts</p>
                                    </div>
                                    <div className="col-md-11">

                                        <p className="text-[#fff] text-[19px] font-[400] leading-[25px]">Choose a convenient time to chat with our accounting experts and get the answers you need to take the next step.</p>
                                    </div>
                                    <div className="col-md-12">
                                        <button className="text-[#000] bg-[#fff] font-[400] py-2 rounded-[50px] hover:text-[#fff] hover:bg-[#000] border transition px-4">Schedula a call</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-md-4">
                                ...
                                <div className="col-md-12">
                                    ...
                                    <p className="text-center text-[15px] font-[500] text-[#9D9D9D] leading-[20px]">
                                        ...
                                        finances, and pay the right experts and tools to track your cash flow, manage your
                                        ax.
                                    </p>
                                </div>
                            </div>
