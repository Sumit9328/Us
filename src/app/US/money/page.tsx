              ...
              <div className="col-12 sm:flex   justify-center gap-2">
                ...
                <div className="col-md-3 rounded-[10px] sm:mb-0 mb-4 px-4 py-2 bg-[#f3efe7]">
                  ...
                  <div className="h-[180px] px-2">
                    ...
                    <p className="text-[15px] font-[400] text-[#656565] leading-[22px]">
                      FDIC-insured for balances up to $250,000. Focus on making
                      money; we’ll keep it secure.
                    </p>
                  </div>
                </div>
                <div className="col-md-3 rounded-[10px] sm:mb-0 mb-4 px-4 py-2 bg-[#f3efe7]">
                  ...
                  <div className="h-[180px] px-2">
                    <p className="text-[16px] font-[500]">No (or low) fees</p>
                    <p className="text-[15px] font-[400] text-[#656565] leading-[22px]">
                      The account and all $USD transfers are free! International
                      transfers are as low as 1%  and transparent: we break it
                      all down before you submit it.
                    </p>
                  </div>
                </div>
                <div className="col-md-3 rounded-[10px] sm:mb-0 mb-4 px-4 py-2 bg-[#f3efe7]">
                  ...
                  <div className="h-[180px] px-2">
                    <p className="text-[16px] font-[500]">Quick Transfers</p>
                    <p className="text-[15px] font-[400] text-[#656565] leading-[22px]">
                      In 1 to 5 days, get your ACH, wire, or international
                      transfers where you want them when you need them.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="sm:flex  sm:mb-0 mb-4 mt-4">
                    <button className="border border-black gap-1 sm:flex  justify-center items-center bg-[#fff] text-[#000] hover:bg-[#000] hover:text-[#fff] rounded-[50px] sm:w-[155px] w-[320px] sm:h-[40px] h-[55px] text-[15px] font-[500]">
                      ...
                      <svg
                        ...
                        className="icon icon-tabler icons-tabler-outline icon-tabler-math-greater mt-[4px]"
                      >
