...
export default function Header1() {
  ...
  return (
    <div>
      <header className="absolute  w-100  py-6 items-center sm:px-20 px-[10px] ">
            ...
            <div className="col-md-2">
              <div className="row ">
                <div className="col-md-9 col-5">
                  <Link href="/">
                    <Image
                      src="/assets/images/Group 17804.png"
                      width={120}
                      height={56}
                      alt="no-img"
                    />
              ...
              <div
                className="sm:hidden block absolute right-[22px] top-[30px]"
                onClick={menuToggle}
              >
                {menu ? (
                  <svg
                  ...
                  >
                    ...
                    <path d="M18 6l-12 12" stroke="#000" />
                    <path d="M6 6l12 12" stroke="#000" />
                  </svg>
                ) : (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="col-md-6">
              <div
                className={
                  width < 500
                    ? menu
                      ? "row flex justify-between items-center absolute bg-[#fff] w-100 left-0 top-[80px] pt-10 pb-28 "
                      : "hidden "
                    : "row flex justify-between items-center"
                }
              >
                <div className="">
                  <div className="text-start items-center sm:flex justify-around sm:px-5 ">
                    <Link
                      href="#"
                      className=" no-underline block sm:pt-[0px] pt-[10px]"
                    >
                      <span className="font-[cd-m] font-[500] text-[#212833] text-end text-[13px]  ">
                        About
                      </span>
                    </Link>
                    <span className="block sm:pt-[0px] pt-[15px] menulist  font-[cd-m] font-[500] text-[#212833]  text-[13px] ">
                      <Link href="/AllMainComponents/formation" className="no-underline text-black">
                      Formation
                      </Link>
  ...
  Products
  <div 
    className="menu-item relative w-[300px] h-[500px] flex justify-center sm:absolute py-[80px] sm:top-[50px] rounded-lg"
    style={{
      height: 'auto', // Allows the height to expand dynamically
      minHeight: '300px', // Sets a minimum height to accommodate your content
    }}
  >

    <div className=" h-[350px] flex items-center">

    <ul className="rounded-lg bg-[#fff] border border-[#A2A2A2] px-4 py-4 z-10 w-full">
      <li className="pt-[5px]">
        <Link
        ...
        >
          Total Compliance
          <p className="text-[14px] text-[#949494]">Embrace worry-free tax filings</p>
        </Link>
      </li>
      <li className="pt-[5px]">
        <Link
      ...
      <li className="pt-[5px]">
        ...
        >
          ...
          <p className="text-[14px] text-[#949494]">Embrace worry-free tax filings</p>
                    ...
                    <Link
                      href="#"
                      className=" no-underline block z-10 sm:pt-[0px] pt-[15px] menulist ff-type font-[100] cursor-pointer  text-[#000] text-start text-[13px] "
                    >
                      <span className="block sm:pt-[0px] pt-[0px]  font-[cd-m] font-[500] text-[#212833]  text-[13px]  ">
                        Pricing
                      </span>
                    </Link>
                  </div>
            ...
            <div className="col-md-2 pe-0">
                  <div className="sm:text-end align-items-center sm:flex sm:justify-end">
                    <Link
                      href="#"
                      className=" no-underline block sm:pt-[0px] pt-[15px]"
                    >
                      <span className="block d-flex align-items-center sm:pt-[7px] pt-[15px] menulist  font-[cd-m] font-[500] text-[#212833]  text-[13px] ">
                        <svg
                          className="mr-4"
                          width="26"
                          height="26"
                    ...
                    <Link
                      href="#"
                      className="block sm:pt-[0px] pt-[15px] ml-5 no-underline align-items-center "
                    >
                      <button
                        className="no-underline block z-10 sm:pt-[7px] pt-[15px] menulist ff-type font-[400] cursor-pointer  text-[#fff] text-start text-[13px] bg-[#000] px-5 py-2 rounded-[30px]"
                        type="button"
                      >
                        Log in
                      </button>
