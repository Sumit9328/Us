            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              >
                ...
                {openMenu === "countryDropdown" && (
                  <ul className="absolute font-[400] pr-4 bg-white shadow-md rounded-md top-[20px] right-[-5px] mt-1 py-1">
                  <li className="px-1 py-2 hover:text-[#0073fd] cursor-pointer">
                    <Link href="/allUAEcomponents">
                      <span className="text-inherit">UAE</span>
                    </Link>
                  </li>
                  <li className="px-1 py-2 hover:text-[#0073fd] cursor-pointer">
                    <Link href="/usa">
                      <span className="text-inherit">USA</span>
                    </Link>
                  </li>
                  <li className="px-1 py-2 hover:text-[#0073fd] cursor-pointer">
                    <Link href="/china">
                      <span className="text-inherit">China</span>
                    </Link>
                  </li>
                  <li className="px-1 py-2 hover:text-[#0073fd] cursor-pointer">
                    <Link href="/india">
                  ...
                  <li className="px-1 py-2 hover:text-[#0073fd] cursor-pointer">
                    <Link href="/germany">
                      <span className="text-inherit">Germany</span>
                    </Link>
                  </li>
                </ul>
                )}
