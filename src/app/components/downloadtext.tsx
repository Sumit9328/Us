  ...
  return (
    <div>
      <div className="row items-center">
        <div className="col-md-6 sm:flex  items-end">
          <div className="col-md-10 w-full">
            ...
            <div className="sm:flex  sm:flex -col sm:flex  -row col-12 items-center mb-4 gap-3">
              <div className="w-full sm:w-8/12">
                <input
                  type="text"
                  placeholder="Enter your Email Address"
                  className="border font-[400] outline-none rounded-[50px] mb-2 px-6 h-[48px] w-full text-[15px] sm:text-[16px]"
                />
              </div>
              <div className="w-full sm:w-4/12">
                <button className="bg-[#0061FE] text-white justify-center items-center rounded-[50px] px-6  w-full sm:flex  text-[18px] font-[400] sm:h-[40px] h-[50px]">
                  Submit
                </button>
              </div>
            </div>
        ...
        <div className="col-md-6 sm:flex  justify-end mb-5">
          <div className="col-md-10 w-full">
            <Image
