...
<Link href="/UK/registercompany" className="no-underline">
        ...
        >
          ...
          <nav className="flex flex-col items-start justify-start pl-6 pt-12 space-y-4 text-gray-600 font-medium">
            ...
            <Link href="/US/comparePackages" className=" no-underline">
              <span className="hover:text-gray-900 text-[16px] text-black no-underline">
                Pricing
              </span>
            </Link>
            ...
            >
              ...
              {openMenu === "countryDropdown" && (
                <ul className="absolute font-[400] bg-white shadow-md rounded-md mt-2 py-1 w-[200px] md:w-[280px] z-50">
                  {["UAE", "USA", "China", "India", "Germany"].map(
                    (country) => (
                      <li
                        key={country}
