          ...
          <div className="sm:mb-0 w-full sm:w-[100%] bg-[#fffdfa] border-8 border-[#f3efe7] rounded-[32px] px-6 py-6">
            <div>
              ...
              <div className="col-12">
                <div className="col-md-7  rounded-[5px] space-x-3 py-1 h-[30px] items-center justify-center mb-0 sm:flex  bg-[#f3efe7]">
          ...
          <div className="sm:mb-0 w-full sm:w-[100%] bg-[#fffdfa] border-8 border-[#f3efe7] rounded-[32px] px-6 py-6">
            <div>
              ...
              <div className="col-12 mb-2">
                <div className="ms-2 w-[180px] rounded-[5px] space-x-3 py-1 h-[30px] items-center justify-center mb-2 sm:flex  bg-[#f3efe7]">
                ...
                <div className="ms-2 sm:w-[276px] rounded-[5px] space-x-3 py-1 sm:h-[30px] h-[45px]    items-center justify-center mb-0 sm:flex  bg-[#f3efe7]">
        ...
        <div className="sm:mb-0 col-11">
          <div className="sm:mb-0 w-full sm:w-[100%] bg-[#fffdfa] border-8 border-[#f3efe7] rounded-[32px] px-6 py-6">
            <div>
              ...
              <div className="col-12 mb-2">
                <div className="ms-2 w-[180px] rounded-[5px] space-x-3 py-1 h-[30px] items-center justify-center mb-0 sm:flex  bg-[#f3efe7]">
