                                ...
                                <div className="col-md-3 rounded-[10px] sm:mb-0 mb-4 px-4 py-2 bg-[#f3efe7]">
                                    ...
                                    <div className="h-[180px] px-2">
                                        ...
                                        <p className="text-[15px] font-[400] text-[#656565] leading-[22px]">
                                            Manage all your transactions from various sources in one intuitive dashboard, saving you time and reducing the risk of errors.
                                        </p>
                                    </div>
                                </div>
                                <div className="col-md-3 rounded-[10px] sm:mb-0 mb-4 px-4 py-2 bg-[#f3efe7]">
                                    ...
                                    <div className="h-[180px] px-2">
                                        ...
                                        <p className="text-[16px] font-[400] text-[#656565] leading-[22px]">
                                            Choose your preferred layout and reflect your brand’s uniqueness with fully customizable invoice templates.
                                        </p>
                                    </div>
                                </div>
                                <div className="col-md-3 rounded-[10px] sm:mb-0 mb-4 px-4 py-2 bg-[#f3efe7]">
                                    ...
                                    <div className="h-[180px] px-2">
                                        ...
                                        <p className="text-[15px] font-[400] text-[#656565] leading-[22px]">
                                            Automate your billing process to ensure timely invoicing and maintain a consistent cash flow.
                                        </p>
                                    </div>
                                </div>
                                <div className="col-md-3 rounded-[10px] sm:mb-0 mb-4 px-4 py-2 bg-[#f3efe7]">
                            ...
                            <div className="col-12">
                                                ...
                                                <div className="sm:h-[350px]">
                                                    <ul className="space-y-4">
                                                        {[
                                                            ...
                                                            {
                                                                content: "Create or connect merchant processing account via Stripe integration",
                                                                status: "tick",
                                                            },
                                                            {
                                                            ...
                                                            {
                                                                content: "Collect payments via the invoices you send with Stripe",
                                                                status: "tick",
                                                            },
                                                        ].map((item, index) => (
                                                            <li
                                                ...
                                                <div className="sm:h-[350px]">
                                                    <ul className="space-y-4">
                                                        {[
                                                            ...
                                                            {
                                                                content: "Connect multiple bank accounts to manage transactions all in one platform",
                                                                status: "tick",
                                                            },
                                                            {
                                                                content: "Tag and categorize income and expense transactions",
                                                                status: "tick",
                                                            },
                                                            {
                                                                content: "Upload and attach receipts to transactions",
                                                                status: "tick",
                                                            },
                                                            {
                                                                content: "Build automated rules for tagging income or expense transactions",
                                                                status: "tick",
                                                            },
                                                        ].map((item, index) => (
                                                            <li
                                            ...
                                            <div>
                                                ...
                                                <div className="sm:h-[350px]">
                                                    <ul className="space-y-4">
                                                        {[
                                                            {
                                                                content: "Dedicated bookkeeping team of Certified Public Accountant’s",
                                                                status: "tick",
                                                            },
                                                            {
                                                            ...
                                                            {
                                                                content: "Categorization of business transactions",
                                                                status: "tick",
                                                            },
                                                            {
                                                                content: "Reconciliation of business bank and credit card accounts (unlimited bank accounts and channels of revenue allowed)",
                                                                status: "tick",
                                                            },
                                                            {
                                ...
                                <div className="col-12 flex justify-center sm:mb-10">
                                    <div className="col-md-6">
                                        <p className="text-center text-[18px] font-[500]">* Includes up to 5000 transactions per year, depending on the package you select. Contact us to learn more.</p>
                                    </div>
                                </div>
                            </div>
